...
![screenshot](../screenshots/arch_updates.png)
![screenshot](../screenshots/arch_updates-1-arch_updates_aur.png)
<details><summary>Display number of pending updates for Arch Linux.</summary>
...
![screenshot](../screenshots/backlight.png)
<details><summary>Adjust screen backlight brightness.</summary>
...
![screenshot](../screenshots/bitcoin_price.png)
<details><summary>Display bitcoin prices using bitcoincharts.com.</summary>
...
![screenshot](../screenshots/check_tcp.png)
![screenshot](../screenshots/check_tcp-1-down.png)
<details><summary>Display status of a TCP port on a given host.</summary>
...
![screenshot](../screenshots/clementine.png)
<details><summary>Display song currently playing in Clementine.</summary>
...
![screenshot](../screenshots/clock-1-london.png)
...
![screenshot](../screenshots/coin_balance.png)
<details><summary>Display balances of diverse crypto-currencies.</summary>
...
![screenshot](../screenshots/deadbeef.png)
<details><summary>Display song currently playing in deadbeef.</summary>
...
![screenshot](../screenshots/diskdata.png)
<details><summary>Display disk information.</summary>
...
![screenshot](../screenshots/exchange_rate.png)
<details><summary>Display foreign exchange rates.</summary>
...
![screenshot](../screenshots/external_script.png)
![screenshot](../screenshots/external_script-1-example.png)
<details><summary>Display output of a given script.</summary>
...
![screenshot](../screenshots/fedora_updates.png)
<details><summary>Display number of pending updates for Fedora Linux.</summary>
...
![screenshot](../screenshots/file_status.png)
![screenshot](../screenshots/file_status-1-missing.png)
<details><summary>Display if a file or directory exists.</summary>
...
![screenshot](../screenshots/gpmdp.png)
<details><summary>Display song currently playing in Google Play Music Desktop Player.</summary>
...
![screenshot](../screenshots/group-2-cycle_again.png)
...
![screenshot](../screenshots/hamster.png)
![screenshot](../screenshots/hamster-1-inactive.png)
<details><summary>Display time tracking activities from Hamster.</summary>
...
### <a name="imap"></a>imap
![screenshot](../screenshots/imap.png)
<details><summary>Display number of unread messages from IMAP account.</summary>
...
![screenshot](../screenshots/mpd_status.png)
<details><summary>Display song currently playing in mpd.</summary>
...
![screenshot](../screenshots/mpris.png)
<details><summary>Display song/video and control MPRIS compatible players.</summary>
...
![screenshot](../screenshots/net_iplist.png)
<details><summary>Display list of network interfaces and IP addresses.</summary>
...
![screenshot](../screenshots/net_rate.png)
<details><summary>Display network transfer rate.</summary>
...
![screenshot](../screenshots/nvidia_temp.png)
<details><summary>Display NVIDIA GPU temperature.</summary>
...
<details><summary>Display response times of the configured Pingdom checks.</summary>
...
![screenshot](../screenshots/player_control.png)
![screenshot](../screenshots/player_control-1-stop.png)
![screenshot](../screenshots/player_control-2-pause.png)
<details><summary>Control Audacious or VLC media player.</summary>
...
![screenshot](../screenshots/pomodoro-1-running.png)
<details><summary>Use Pomodoro technique to get things done easily.</summary>
...
![screenshot](../screenshots/rainbow.png)
<details><summary>Add color cycling fun to your i3bar.</summary>
...
![screenshot](../screenshots/rate_counter.png)
<details><summary>Display time spent and calculate the price of your service.</summary>
...
![screenshot](../screenshots/scratchpad_async.png)
<details><summary>Display number of windows and urgency hints asynchronously.</summary>
...
![screenshot](../screenshots/scratchpad_counter.png)
<details><summary>Display number of windows in scratchpad.</summary>
...
<details><summary>Take screenshots and upload them to a given server.</summary>
...
![screenshot](../screenshots/selinux.png)
![screenshot](../screenshots/selinux-1-permissive.png)
![screenshot](../screenshots/selinux-2-disabled.png)
<details><summary>Display SELinux state.</summary>
...
![screenshot](../screenshots/spaceapi.png)
<details><summary>Display status of a given hackerspace.</summary>
...
![screenshot](../screenshots/static_string.png)
<details><summary>Display static text.</summary>
...
![screenshot](../screenshots/sysdata.png)
<details><summary>Display system RAM, SWAP and CPU utilization.</summary>
...
![screenshot](../screenshots/taskwarrior.png)
<details><summary>Display tasks currently running in taskwarrior.</summary>
...
![screenshot](../screenshots/uname.png)
<details><summary>Display system information from uname.</summary>
...
![screenshot](../screenshots/vnstat.png)
<details><summary>Display vnstat statistics.</summary>
...
![screenshot](../screenshots/weather_yahoo.png)
<details><summary>Display Yahoo! Weather forecast.</summary>
...
![screenshot](../screenshots/whatismyip-2-mode.png)
...
![screenshot](../screenshots/whoami.png)
<details><summary>Display logged-in username.</summary>
...
### <a name="wifi"></a>wifi
![screenshot](../screenshots/wifi.png)
<details><summary>Display WiFi bit rate, quality, signal and SSID using iw.</summary>
...
![screenshot](../screenshots/window_title.png)
<details><summary>Display current window title.</summary>
...
![screenshot](../screenshots/window_title_async.png)
<details><summary>Display current window title asynchronously.</summary>
...
### <a name="xsel"></a>xsel
![screenshot](../screenshots/xsel.png)
![screenshot](../screenshots/xsel-1-example.png)
<details><summary>Display X selection.</summary>
