...
def test_13():
    run_formatter(
        {"format": "pre [{missing}|empty] post", "expected": "pre  post"}
    )


def test_14():
    run_formatter(
        {"format": "pre [{missing}|empty] post|After", "expected": "After"}
    )
...
def test_16a():
    run_formatter(
        {"format": "x {module_method}", "expected": "x {module_method}"}
    )
...
def test_26():
    run_formatter(
        {"format": "[{zero} ping] hello", "expected": "0 ping hello"}
    )
...
def test_35():
    run_formatter(
        {"format": "[{yes} ping] hello", "expected": "True ping hello"}
    )
...
def test_41():
    run_formatter(
        {"format": "Hello {python2_str}! ☂", "expected": "Hello Björk! ☂"}
    )


def test_42():
    run_formatter(
        {"format": u"Hello {python2_str}! ☂", "expected": "Hello Björk! ☂"}
    )
...
def test_45():
    ...
    run_formatter(
        {"format": "{name!r}", "expected": "'Björk'", "py3only": True}
    )
...
def test_64():
    run_formatter(
        {"format": "[\?if=yes Hello[ {name}]]", "expected": "Hello Björk"}
    )
...
def test_color_name_7a():
    run_formatter(
        {"format": "[\?color=#BADHEX&show color]", "expected": "color"}
    )
    ...
    run_formatter(
        {
            ...
            "expected": [
                {"full_text": "LA 09:34NY 12:34", "color": "#FF0000"}
            ],
        }
    )
    ...
    run_formatter(
        {
            ...
            "expected": [
                {"full_text": "LA 09:34NY 12:34", "color": "#FF00FF"}
            ],
        }
    )
...
def test_min_length_2():
    run_formatter(
        {"format": "[\?min_length=9&show Hello]", "expected": "    Hello"}
    )


def test_min_length_3():
    run_formatter(
        {"format": "[\?min_length=9 [{name}]]", "expected": u"    Björk"}
    )
...
def test_not_zero_9():
    run_formatter(
        {"format": "[\?not_zero {str_nan}]", "expected": "I'm not a number"}
    )
...
def test_soft_1():
    run_formatter(
        {"format": "{name}[\?soft  ]{name}", "expected": "Björk Björk"}
    )
...
def test_soft_6():
    run_formatter(
        {"format": "{number}[\?soft  {name} ]{empty}", "expected": "42"}
    )
...
def test_module_true():
    run_formatter(
        {"format": "[\?if=module_true something]", "expected": "something"}
    )
...
def test_zero_format_1():
    run_formatter(
        {"format": "[\?not_zero {zero_almost}]", "expected": "0.0001"}
    )
...
def test_zero_format_4():
    run_formatter(
        {"format": "[\?not_zero {zero_almost:.4f}]", "expected": "0.0001"}
    )
...
def test_conditions_1():
    run_formatter(
        {"format": "\?if=number=42 cool beans", "expected": "cool beans"}
    )
...
def test_conditions_4():
    run_formatter(
        {"format": "\?if=!number=4 cool beans", "expected": "cool beans"}
    )
...
def test_conditions_6():
    run_formatter(
        {"format": "\?if=name=Björk cool beans", "expected": "cool beans"}
    )
...
def test_conditions_12():
    run_formatter(
        {"format": "\?if=yes=3 cool beans", "expected": "cool beans"}
    )
...
def test_conditions_14():
    run_formatter(
        {"format": "\?if=number>3 cool beans", "expected": "cool beans"}
    )


def test_conditions_15():
    run_formatter(
        {"format": "\?if=number<50 cool beans", "expected": "cool beans"}
    )
...
def test_conditions_19():
    run_formatter(
        {"format": "\?if=name>Andrew cool beans", "expected": "cool beans"}
    )


def test_conditions_20():
    run_formatter(
        {"format": "\?if=name<John cool beans", "expected": "cool beans"}
    )
...
def test_conditions_23():
    run_formatter(
        {"format": "[\?if=None=None cool] beans", "expected": " beans"}
    )
